        ...
        <div className="relative w-screen h-screen overflow-hidden  text-black">
            <div className="absolute top-0 w-full h-16 px-16 flex justify-between items-center">
                <div className="flex gap-1 items-center">
                    ...
                    <span className="font-semibold text-xl text-text">
                        Logiq
                    </span>
                </div>
            ...
            <div className="text-text w-full text-center z-20  absolute top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2  flex flex-col items-center justify-center">
                <span className="text-[10vw] font-semibold leading-[0.8]">
                    LOGIQ
                </span>

                <p className="mt-6 text-base">
                    By Inter Departmental Coding Competition (IDCC)
                </p>

                <p className="mt-2 text-sm max-w-xl mx-auto">
                    Join others as you compete in exciting coding challenges and
                    solve problems in a timed environment. Sharpen your skills
                    and have fun!
                </p>

                <Link
                    to="/user/login"
                    className="flex items-center gap-2 text-base border border-gray-300 mt-6 px-4 py-2 bg-bg font-semibold rounded-lg  hover:bg-gray-200 transition z-20 relative"
                >
                    Get Started
                    <ArrowRight size={16} />
                </Link>
