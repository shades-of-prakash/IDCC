...
const ConfigureArguments = ({ close, initialArgs = [], problemId }) => {
    ...
    const { mutate: saveArguments, isPending } = useMutation({
        ...
        onSuccess: () => {
            ...
            close(); // Close immediately after save
        },
        onError: (err) => {
        ...
        <div className="h-full flex flex-col bg-white p-4">
            ...
            <div className="pt-3 flex justify-end">
                <button
                    ...
                    className="flex items-center gap-2 rounded px-3 py-1.5 text-sm font-medium bg-black text-white hover:bg-black/90 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                    {isPending ? (
                        <>
