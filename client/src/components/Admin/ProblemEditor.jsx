...
const Problem = () => {
  ...
  if (isLoading) {
    return (
      <InfoCard
        ...
        description="Fetching problem details..."
        className="bg-white"
      />
    );
  }
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gray-50">
      {/* HEADER */}
      <div className="w-full h-16 flex justify-between px-4 border-b border-gray-300 bg-white">
        <div className="flex gap-3 items-center">
          <button onClick={() => navigate(-1)}>
            <ArrowLeft size={22} className="hover:text-black text-black/80" />
          </button>
        ...
        <button
          ...
          className="px-2 py-1.5 rounded-md bg-black hover:bg-black/90 text-white font-medium disabled:opacity-50"
        >
