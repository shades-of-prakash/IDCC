...
const ContestNavbar = ({ toggle }) => {
	return (
		<div className="w-full h-full border-b border-gray-300  text-black px-4">
			<div className="w-full h-full flex items-center justify-between">
				...
				<button
					onClick={toggle}
					className="flex items-center gap-2 px-4 py-2 bg-black/90 text-white  font-medium rounded shadow hover:bg-black"
				>
