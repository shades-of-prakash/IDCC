        ...
        <div className="w-full  flex flex-col items-center">
          ...
          <div className="w-full flex justify-between items-center py-2">
            <div className="flex select-none">
              ...
              <div className="flex items-center gap-2 border-l-0 px-3 py-2 border border-slate-200">
                <span className="font-medium text-gray-600 text-sm">
                  Points:
                </span>
                <span>{selectedProblem.points}</span>
              </div>
              <div className="flex items-center gap-3 px-3 py-2 border-l-0 rounded-e-md border border-slate-200">
                <div className="rounded w-6 h-6 overflow-hidden">
                  <img
                    src={getAvatar(selectedProblem.submittedBy.username)}
                    alt="avatar"
                  />
                </div>
