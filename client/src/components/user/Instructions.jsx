...
const Instructions = () => {
    ...
    return (
        <>
            {showWalkthrough ? (
                <EditorWalkthrough onFinish={() => setShowWalkthrough(false)} />
            ) : (
                <div className="flex items-center justify-center h-screen w-full bg-white   p-4">
                    ...
                    <div className="w-8/12 h-full flex flex-col relative">
                        ...
                        <div className="px-8 py-6 e z-10 shrink-0">
                            ...
                            {!selectedContest && (
                                <div className="mt-3 flex items-center gap-2 text-xs font-medium bg-red-50 text-red-700 p-2 rounded border border-red-200">
                                    <Info size={14} /> No contest assigned.
                                    Preview mode.
                                </div>
                            )}
                        ...
                        <div className="absolute bg-white bottom-0 w-full  border-t border-gray-200 p-6 flex justify-between items-center z-20 ">
                            {/* Back Button */}
                            <button
                                onClick={() => setShowWalkthrough(true)}
                                className="w-fit flex items-center gap-2 text-sm font-bold text-neutral-600 hover:text-black"
                            >
                                ← Back to Editor Walkthrough
                            </button>
